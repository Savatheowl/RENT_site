...
from app.models import Agency, Property, Request, Review, User
...
def agency_detail(id):
    ...
    return render_template(
        "main/agency_detail.html", agency=agency, properties=properties
    )
...
def my_requests():
    if current_user.is_tenant():
        requests_list = current_user.requests.order_by(Request.created_at.desc()).all()
